...
export default function Ugandan5DaysPage() {
  return (
    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 parallax-bg bg-cover bg-center transition-transform duration-1000 ease-out transform scale-100 hover:scale-105" style={{"backgroundImage":"url('https://readdy.ai/api/search-image?query=mountain%20gorillas%20in%20misty%20bwindi%20forest%2C%20volcanic%20mountains%20southwest%20uganda%2C%20batwa%20cultural%20village%20lake%20bunyonyi%20scenery%2C%20professional%20wildlife%20photography%2C%20dramatic%20green%20landscape&width=1920&height=1080&seq=kisoro-hero&orientation=landscape')"}}>
        </div>
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mb-6 leading-tight">
                ...
                <span className="block mt-2 text-white">of Southwest Uganda</span>
            </h1>
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto text-gray-200 relative inline-block group">
                <span>5-Day The Best of Kisoro Tour: Gorillas, Culture & Lake Bunyonyi</span>
    ...
    <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
                <h2 className="text-4xl font-bold text-gray-900 mb-4">5-Day The Best of Kisoro Tour</h2>
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">Gorilla trekking, Batwa culture, golden monkeys, and
                    serene Lake Bunyonyi in one unforgettable private tour</p>
            </div>
            ...
            <div className="relative">
                ...
                <div className="space-y-12">
                    ...
                    <div className="relative flex items-start">
                        ...
                        <div className="ml-20 day-card bg-white rounded-xl shadow-lg p-6 w-full">
                            <div className="flex justify-between items-start mb-4">
                                <h3 className="text-2xl font-bold text-gray-900">Day 1: Arrival & Transfer to Kisoro</h3>
                                <span className="text-sm text-gray-500 bg-gray-100 px-3 py-1 rounded-full">Entebbe to
                                    Kisoro</span>
                            </div>
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <ul className="text-gray-600 space-y-1">
                                        ...
                                        <li>• Meet your personal guide from WildMed</li>
                                        <li>• Scenic drive through Southwest Uganda</li>
                                        <li>• Views of lush green hills and local life</li>
                                    </ul>
                                </div>
                                <div>
                                    <h4 className="font-semibold text-gray-800 mb-2 flex items-center">
                                    ...
                                    <ul className="text-gray-600 space-y-1">
                                        <li>• Check into Ichumbi Hotel</li>
                                        <li>• Unwind after your journey</li>
                                        <li>• Dinner at the lodge</li>
                                        <li>• Briefing about the days ahead</li>
                                    </ul>
                                </div>
                            </div>
                            <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                                ...
                                <p className="text-gray-600 text-sm">Kisoro is nestled near the borders of Rwanda and DRC,
                                    surrounded by volcanic mountains. The drive offers spectacular views of Uganda's
                                    famous terraced hills.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative flex items-start">
                        ...
                        <div className="ml-20 day-card bg-white rounded-xl shadow-lg p-6 w-full">
                            <div className="flex justify-between items-start mb-4">
                                <h3 className="text-2xl font-bold text-gray-900">Day 2: Gorilla Trekking in Mgahinga</h3>
                                <span className="text-sm text-gray-500 bg-gray-100 px-3 py-1 rounded-full">Mgahinga Gorilla
                                    National Park</span>
                            </div>
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <ul className="text-gray-600 space-y-1">
                                        ...
                                        <li>• Transfer to Mgahinga Gorilla National Park</li>
                                        <li>• Briefing by park rangers</li>
                                ...
                                <div>
                                    ...
                                    <ul className="text-gray-600 space-y-1">
                                        ...
                                        <li>• Optional village walk in evening</li>
                                    </ul>
                                </div>
                            </div>
                            <div className="mt-4 p-4 bg-green-50 rounded-lg">
                                ...
                                <p className="text-gray-600 text-sm">Mgahinga is one of only three parks in the world where
                                    you can see endangered mountain gorillas. Our expert guides ensure a safe and
                                    unforgettable encounter.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative flex items-start">
                        ...
                        <div className="ml-20 day-card bg-white rounded-xl shadow-lg p-6 w-full">
                            <div className="flex justify-between items-start mb-4">
                                <h3 className="text-2xl font-bold text-gray-900">Day 3: Batwa Culture & Coffee Experience
                                </h3>
                                <span className="text-sm text-gray-500 bg-gray-100 px-3 py-1 rounded-full">Cultural
                                    Immersion Day</span>
                            </div>
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    <h4 className="font-semibold text-gray-800 mb-2 flex items-center">
                                        <div className="w-5 h-5 flex items-center justify-center mr-2">
                                            <i className="ri-community-line text-red-500"></i>
                                        </div>
                                        Batwa Cultural Trail
                                    </h4>
                                    <ul className="text-gray-600 space-y-1">
                                        <li>• Visit the indigenous Batwa people</li>
                                        <li>• Learn about ancient forest lifestyle</li>
                                        <li>• Traditional medicine demonstration</li>
                                        <li>• Storytelling and cultural exchange</li>
                                        <li>• Support community tourism</li>
                                    </ul>
                                </div>
                                <div>
                                    <h4 className="font-semibold text-gray-800 mb-2 flex items-center">
                                        <div className="w-5 h-5 flex items-center justify-center mr-2">
                                            <i className="ri-cup-line text-green-500"></i>
                                        </div>
                                        Coffee Farm Experience
                                    </h4>
                                    <ul className="text-gray-600 space-y-1">
                                        <li>• Visit local coffee farm</li>
                                        <li>• Hands-on harvesting experience</li>
                                        <li>• Learn roasting techniques</li>
                                        <li>• Taste Uganda's famed Arabica coffee</li>
                            ...
                            <div className="mt-4 p-4 bg-yellow-50 rounded-lg">
                                <h4 className="font-semibold text-gray-800 mb-2 flex items-center">
                                    <div className="w-5 h-5 flex items-center justify-center mr-2">
                                        <i className="ri-heart-line text-yellow-600"></i>
                                    </div>
                                    Cultural Significance
                                </h4>
                                <p className="text-gray-600 text-sm">The Batwa are the original inhabitants of these
                                    forests. This experience helps preserve their heritage while providing sustainable
                    ...
                    <div className="relative flex items-start">
                        ...
                        <div className="ml-20 day-card bg-white rounded-xl shadow-lg p-6 w-full">
                            <div className="flex justify-between items-start mb-4">
                                <h3 className="text-2xl font-bold text-gray-900">Day 4: Golden Monkeys & Lake Bunyonyi</h3>
                                <span className="text-sm text-gray-500 bg-gray-100 px-3 py-1 rounded-full">Kisoro to Lake
                                    Bunyonyi</span>
                            </div>
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    <h4 className="font-semibold text-gray-800 mb-2 flex items-center">
                                        <div className="w-5 h-5 flex items-center justify-center mr-2">
                                            <i className="ri-monkey-line text-yellow-500"></i>
                                        </div>
                                        Golden Monkey Tracking
                                    </h4>
                                    <ul className="text-gray-600 space-y-1">
                                        <li>• Morning golden monkey tracking</li>
                                        <li>• See these playful primates in bamboo</li>
                                ...
                                <div>
                                    <h4 className="font-semibold text-gray-800 mb-2 flex items-center">
                                        <div className="w-5 h-5 flex items-center justify-center mr-2">
                                            <i className="ri-sailboat-line text-blue-500"></i>
                                        </div>
                                        Lake Bunyonyi Transfer
                                    </h4>
                                    <ul className="text-gray-600 space-y-1">
                                        <li>• Scenic drive to Lake Bunyonyi</li>
                                        <li>• Check into Arcadia Lodge</li>
                                        <li>• Relaxing boat ride on the lake</li>
                                        <li>• Visit "Place of Many Birds" islands</li>
                                    </ul>
                                </div>
                            </div>
                            <div className="mt-4 p-4 bg-purple-50 rounded-lg">
                                ...
                                <p className="text-gray-600 text-sm">Lake Bunyonyi is Africa's second deepest lake, with 29
                                    islands and stunning scenery. It's known for its tranquility and birdlife - perfect
                                    for relaxation.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative flex items-start">
                        ...
                        <div className="ml-20 day-card bg-white rounded-xl shadow-lg p-6 w-full">
                            <div className="flex justify-between items-start mb-4">
                                <h3 className="text-2xl font-bold text-gray-900">Day 5: Lake Sunrise & Return to Entebbe
                                </h3>
                                <span className="text-sm text-gray-500 bg-gray-100 px-3 py-1 rounded-full">Lake Bunyonyi to
                                    Entebbe</span>
                            </div>
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    <h4 className="font-semibold text-gray-800 mb-2 flex items-center">
                                        ...
                                        Morning at Lake Bunyonyi
                                    </h4>
                                    <ul className="text-gray-600 space-y-1">
                                        <li>• Sunrise views over the lake</li>
                                        <li>• Final breakfast at lakeside</li>
                                        <li>• Optional morning canoe ride</li>
                                        <li>• Photography of misty landscapes</li>
                                    </ul>
                                </div>
                                <div>
                                    <h4 className="font-semibold text-gray-800 mb-2 flex items-center">
                                    ...
                                    <ul className="text-gray-600 space-y-1">
                                        <li>• Begin return journey to Entebbe</li>
                                        <li>• Stop for lunch en route</li>
                                        <li>• Scenic drive through countryside</li>
                            ...
                            <div className="mt-4 p-4 bg-yellow-50 rounded-lg">
                                ...
                                <p className="text-gray-600 text-sm">Schedule flights for evening (after 6pm) to allow
                                    comfortable travel time. We recommend overnight in Entebbe if you have early morning
                                    flights.</p>
                            </div>
                        </div>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer">
                    <img src="assets/kisoro-tour/kisoro1.png" alt="Mountain Gorillas in Mgahinga" className="w-full h-48 object-cover hover:scale-105 transition-transform" />
                </div>
                <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer">
                    <img src="assets/kisoro-tour/kisoro2.png" alt="Golden Monkey Tracking" className="w-full h-48 object-cover hover:scale-105 transition-transform" />
                </div>
                <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer">
                    <img src="assets/kisoro-tour/kisoro3.png" alt="Batwa Cultural Experience" className="w-full h-48 object-cover hover:scale-105 transition-transform" />
                </div>
                <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer">
                    <img src="assets/kisoro-tour/kisoro4.png" alt="Coffee Farm Visit" className="w-full h-48 object-cover hover:scale-105 transition-transform" />
                </div>
                <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer">
                    <img src="assets/kisoro-tour/kisoro5.png" alt="Lake Bunyonyi Scenery" className="w-full h-48 object-cover hover:scale-105 transition-transform" />
                </div>
                <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer">
                    <img src="assets/kisoro-tour/kisoro6.png" alt="Boat Ride on Lake" className="w-full h-48 object-cover hover:scale-105 transition-transform" />
                </div>
                {/*  <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer"
                    onClick={undefined}>
                    <img src="assets/kisoro-tour/kisoro7.jpg" alt="Ichumbi Hotel Kisoro"
                        className="w-full h-48 object-cover hover:scale-105 transition-transform">
                </div>
                <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer"
                    onClick={undefined}>
                    <img src="assets/kisoro-tour/kisoro8.jpg" alt="Arcadia Lodge Lake Bunyonyi"
                        className="w-full h-48 object-cover hover:scale-105 transition-transform">
                </div>  */}
            </div>
        </div>
    ...
    <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600">Comfortable mid-range lodges with authentic Ugandan hospitality</p>
            </div>

            {/*  Accommodations Highlight  */}
            <div className="mb-16">
                <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Your Comfortable Stay</h3>
                <div className="grid md:grid-cols-2 gap-8">
                    {/*  Ichumbi Hotel  */}
                    <div className="bg-gray-50 rounded-2xl overflow-hidden shadow-lg">
                        <div className="h-64 overflow-hidden">
                            <img src="assets/kisoro-tour/ichumbi-hotel.jpg" alt="Ichumbi Hotel Kisoro" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
                        </div>
                        <div className="p-6">
                            <div className="flex justify-between items-start mb-4">
                                <div>
                                    <h4 className="text-xl font-bold text-gray-900">Ichumbi Hotel</h4>
                                    <p className="text-gray-600">Kisoro • 3 Nights</p>
                                </div>
                                <span className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm font-medium">Mid-range</span>
                            </div>
                            <p className="text-gray-600 mb-4">Comfortable hotel with stunning views of the Virunga
                                volcanoes. Known for warm hospitality and excellent local cuisine.</p>
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center text-gray-600">
                                    ...
                                    <span className="text-sm">On-site restaurant</span>
                                </div>
                                <div className="flex items-center text-gray-600">
                                ...
                                <div className="flex items-center text-gray-600">
                                    <i className="ri-landscape-line mr-2 text-green-600"></i>
                    ...
                    <div className="bg-gray-50 rounded-2xl overflow-hidden shadow-lg">
                        <div className="h-64 overflow-hidden">
                            <img src="assets/kisoro-tour/arcadia-lodge.jpg" alt="Arcadia Lodge Lake Bunyonyi" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
                        </div>
                        <div className="p-6">
                            <div className="flex justify-between items-start mb-4">
                                <div>
                                    <h4 className="text-xl font-bold text-gray-900">Arcadia Lodge Lake Bunyonyi</h4>
                                    <p className="text-gray-600">Lake Bunyonyi • 1 Night</p>
                                </div>
                                <span className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm font-medium">Lakeside
                                    Mid-range</span>
                            </div>
                            <p className="text-gray-600 mb-4">Beautiful lakeside lodge offering tranquility and stunning
                                views. Perfect for relaxation after your adventures.</p>
                            <div className="space-y-2">
                                <div className="flex items-center text-gray-600">
                                    <i className="ri-sailboat-line mr-2 text-blue-600"></i>
                                    <span className="text-sm">Private boat access</span>
                                </div>
                                <div className="flex items-center text-gray-600">
                                    <i className="ri-restaurant-line mr-2 text-blue-600"></i>
                                    <span className="text-sm">Lakeside dining</span>
                                </div>
                                <div className="flex items-center text-gray-600">
                                    <i className="ri-bird-line mr-2 text-blue-600"></i>
                                    <span className="text-sm">Birdwatching paradise</span>
                                </div>
                                <div className="flex items-center text-gray-600">
                                    <i className="ri-sun-line mr-2 text-blue-600"></i>
                                    <span className="text-sm">Sunrise views</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="mb-16">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-gray-600 text-sm">Tailor itinerary to your preferences</p>
                    </div>
                    <div className="bg-white border border-gray-200 rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                        <div className="w-12 h-12 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-4">
                            <i className="ri-user-heart-line text-amber-600 text-xl"></i>
                        </div>
                        <h4 className="font-semibold text-gray-900 mb-2">Solo Traveler Friendly</h4>
                        <p className="text-gray-600 text-sm">Perfect for individual adventurers</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
                <div className="bg-green-50 rounded-2xl p-6 shadow-sm">
                    ...
                    <ul className="space-y-3">
                        <li className="flex items-start">
                            ...
                            <span className="text-gray-700">Airport transfers on arrival and departure</span>
                        </li>
                        <li className="flex items-start">
                            <i className="ri-checkbox-circle-fill text-green-500 mt-1 mr-3"></i>
                            <span className="text-gray-700">All internal transport in luxury 4x4 vehicle</span>
                        </li>
                        <li className="flex items-start">
                            <i className="ri-checkbox-circle-fill text-green-500 mt-1 mr-3"></i>
                        ...
                        <li className="flex items-start">
                            <i className="ri-checkbox-circle-fill text-green-500 mt-1 mr-3"></i>
                            <span className="text-gray-700">Gorilla trekking permit (USD 800 value)</span>
                        </li>
                        <li className="flex items-start">
                            <i className="ri-checkbox-circle-fill text-green-500 mt-1 mr-3"></i>
                            <span className="text-gray-700">Golden monkey tracking permit</span>
                        </li>
                        <li className="flex items-start">
                            <i className="ri-checkbox-circle-fill text-green-500 mt-1 mr-3"></i>
                            <span className="text-gray-700">All accommodation (4 nights mid-range)</span>
                        </li>
                        <li className="flex items-start">
                            <i className="ri-checkbox-circle-fill text-green-500 mt-1 mr-3"></i>
                        ...
                        <li className="flex items-start">
                            <i className="ri-checkbox-circle-fill text-green-500 mt-1 mr-3"></i>
                            <span className="text-gray-700">All entrance fees and activity costs</span>
                        </li>
                        <li className="flex items-start">
                            <i className="ri-checkbox-circle-fill text-green-500 mt-1 mr-3"></i>
                    ...
                    <div className="mt-6 p-4 bg-white rounded-lg">
                        <p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Gorilla permits are
                            limited and must be booked well in advance. Minimum age: 17 years for gorilla trekking.</p>
                    </div>
                </div>
                ...
                <div className="bg-red-50 rounded-2xl p-6 shadow-sm">
                    ...
                    <ul className="space-y-3">
                        ...
                        <li className="flex items-start">
                            <i className="ri-close-circle-fill text-red-500 mt-1 mr-3"></i>
                            <span className="text-gray-700">Personal expenses (laundry, phone calls)</span>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600">All-inclusive 5-day private tour with gorilla permits</p>
            </div>
            <div className="bg-gray-50 rounded-2xl p-8">
                <div className="grid lg:grid-cols-2 gap-8">
                    <div>
                        <h3 className="text-2xl font-bold text-gray-900 mb-6">5-Day Best of Kisoro Tour Package</h3>
                        <div className="space-y-4">
                            <div className="flex justify-between items-center py-3 border-b border-gray-200">
                                <span className="text-gray-700">Base tour package (per person)</span>
                            ...
                            <div className="flex justify-between items-center py-3 border-b border-gray-200">
                                <span className="text-gray-700">Cultural experiences & activities</span>
                            ...
                            <div className="flex justify-between items-center py-3 font-bold text-lg bg-green-50 px-4 rounded-lg">
                                ...
                                <span className="text-secondary text-2xl">$3,870 USD*</span>
                            </div>
                        ...
                        <div className="mt-8 p-4 bg-blue-50 rounded-lg">
                            <h4 className="font-semibold text-blue-800 mb-2">Early Booking Benefits</h4>
                            <ul className="text-blue-700 text-sm space-y-1">
                                <li>• 10% discount for bookings 4+ months in advance</li>
                                <li>• Free airport hotel night if needed</li>
                                <li>• Complimentary Batwa craft souvenir</li>
                    ...
                    <div>
                        <div className="bg-white rounded-xl p-6 shadow-lg mb-6">
                            ...
                            <ul className="text-gray-600 space-y-2">
                                <li>• All accommodation (4 nights mid-range)</li>
                                <li>• All meals as specified in itinerary</li>
                                <li>• Professional English-speaking guide</li>
                                <li>• Private 4x4 transportation</li>
                                <li>• Gorilla & golden monkey permits</li>
                                <li>• All park entrance fees</li>
                                <li>• Batwa Cultural Trail experience</li>
                                <li>• Lake Bunyonyi boat ride</li>
    ...
    <div id="bookingModal" className="fixed inset-0 z-50 hidden w-full h-full bg-black bg-opacity-80 overflow-y-auto">
        <div className="relative w-full min-h-screen flex items-center justify-center px-4 py-12">
            <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl relative fade-in">
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">Book Your 5-Day Best of Kisoro Tour</h2>
                <form id="customBookingForm" className="space-y-6">
                    <input type="hidden" name="safari" defaultValue="5-Day Best of Kisoro Tour" />
                    <div>

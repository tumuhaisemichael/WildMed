...
export default function Ugandan3DaysPage() {
  return (
    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 parallax-bg bg-cover bg-center transition-transform duration-1000 ease-out transform scale-100 hover:scale-105" style={{"backgroundImage":"url('https://readdy.ai/api/search-image?query=bwindi%20impenetrable%20forest%20gorilla%20trekking%20misty%20mountains%20uganda%20batwa%20cultural%20village%20green%20canopy%20professional%20wildlife%20photography&width=1920&height=1080&seq=3day-gorilla-hero&orientation=landscape')"}}>
        </div>
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mb-6 leading-tight">
                ...
                <span className="block mt-2 text-white">of Mountain Gorillas</span>
            </h1>
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto text-gray-200 relative inline-block group">
                <span>3-Day Gorilla Trekking & Batwa Experience - Perfect for Last-Minute Adventures</span>
            ...
            <button id="startPlanningBtn" className="relative overflow-hidden group bg-gradient-to-r from-green-600 to-green-700 hover:from-green-500 hover:to-green-600 text-white px-10 py-5 rounded-xl text-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-green-500/20">
                <span className="relative z-10 flex items-center justify-center space-x-2">
                    ...
                    <span>Book Your Gorilla Adventure</span>
                </span>
    ...
    <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
                <h2 className="text-4xl font-bold text-gray-900 mb-4">3-Day Gorilla Trekking & Batwa Experience</h2>
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">A compact yet powerful itinerary combining gorilla
                    encounters with meaningful cultural immersion</p>
            </div>
            ...
            <div className="relative">
                ...
                <div className="space-y-12">
                    ...
                    <div className="relative flex items-start">
                        ...
                        <div className="ml-20 day-card bg-white rounded-xl shadow-lg p-6 w-full">
                            <div className="flex justify-between items-start mb-4">
                                <h3 className="text-2xl font-bold text-gray-900">Day 1: Journey to Bwindi Impenetrable
                                    Forest</h3>
                                <span className="text-sm text-gray-500 bg-gray-100 px-3 py-1 rounded-full">Entebbe/Kampala
                                    to Bwindi</span>
                            </div>
                                ...
                                <div>
                                    <h4 className="font-semibold text-gray-800 mb-2 flex items-center">
                                        <div className="w-5 h-5 flex items-center justify-center mr-2">
                                            <i className="ri-car-line text-secondary"></i>
                                        </div>
                                        Scenic Transfer
                                    </h4>
                                    <ul className="text-gray-600 space-y-1">
                                        <li>• Pickup from Entebbe Airport or Kampala hotel</li>
                                        <li>• Drive through lush green landscapes</li>
                                        <li>• Journey to Southwest Uganda</li>
                                        <li>• Arrive at Bwindi Impenetrable National Park</li>
                                    </ul>
                                </div>
                                <div>
                                    <h4 className="font-semibold text-gray-800 mb-2 flex items-center">
                                    ...
                                    <ul className="text-gray-600 space-y-1">
                                        <li>• Check into Rushaga Gorilla Lodge</li>
                                        <li>• Briefing about gorilla trekking</li>
                                        <li>• Dinner and overnight stay</li>
                                        <li>• Prepare for next day's adventure</li>
                                    </ul>
                                </div>
                            </div>
                            <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                                ...
                                <p className="text-gray-600 text-sm">Bwindi Impenetrable National Park is home to nearly
                                    half the world's remaining mountain gorillas. The park is a UNESCO World Heritage
                                    Site.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative flex items-start">
                        ...
                        <div className="ml-20 day-card bg-white rounded-xl shadow-lg p-6 w-full">
                            <div className="flex justify-between items-start mb-4">
                                <h3 className="text-2xl font-bold text-gray-900">Day 2: Gorilla Trekking & Batwa Culture
                                </h3>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <ul className="text-gray-600 space-y-1">
                                        <li>• Early morning briefing at park headquarters</li>
                                        <li>• Guided trek into the impenetrable forest</li>
                                        <li>• Find and observe mountain gorilla family</li>
                                        <li>• 1 unforgettable hour with the gorillas</li>
                                ...
                                <div>
                                    <h4 className="font-semibold text-gray-800 mb-2 flex items-center">
                                        <div className="w-5 h-5 flex items-center justify-center mr-2">
                                            <i className="ri-community-line text-green-500"></i>
                                        </div>
                                        Batwa Cultural Experience
                                    </h4>
                                    <ul className="text-gray-600 space-y-1">
                                        <li>• Afternoon visit to Batwa community</li>
                                        <li>• Learn about indigenous forest lifestyle</li>
                                        <li>• Traditional dances and storytelling</li>
                                        <li>• Cultural exchange with Batwa people</li>
                                        <li>• Understand their conservation role</li>
                                    </ul>
                                </div>
                            </div>
                            <div className="mt-4 p-4 bg-green-50 rounded-lg">
                                ...
                                <p className="text-gray-600 text-sm">Your visit supports both gorilla conservation and Batwa
                                    community livelihoods. Tourism provides sustainable income for forest protection.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative flex items-start">
                        ...
                        <div className="ml-20 day-card bg-white rounded-xl shadow-lg p-6 w-full">
                            <div className="flex justify-between items-start mb-4">
                                <h3 className="text-2xl font-bold text-gray-900">Day 3: Return to Kampala/Entebbe</h3>
                                <span className="text-sm text-gray-500 bg-gray-100 px-3 py-1 rounded-full">Bwindi to
                                    Entebbe/Kampala</span>
                            </div>
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    <h4 className="font-semibold text-gray-800 mb-2 flex items-center">
                                    ...
                                    <ul className="text-gray-600 space-y-1">
                                        <li>• Final breakfast at Rushaga Gorilla Lodge</li>
                                        <li>• Last views of the forest canopy</li>
                                        <li>• Opportunity for souvenir shopping</li>
                                        <li>• Share trekking stories with fellow travelers</li>
                                    </ul>
                                </div>
                                <div>
                                    <h4 className="font-semibold text-gray-800 mb-2 flex items-center">
                                        <div className="w-5 h-5 flex items-center justify-center mr-2">
                                            <i className="ri-plane-line text-blue-500"></i>
                                        </div>
                                        Return Journey
                                    </h4>
                                    <ul className="text-gray-600 space-y-1">
                                        <li>• Begin return journey with packed lunch</li>
                                        <li>• Scenic drive through Ugandan countryside</li>
                                        <li>• Stop for photos and refreshments</li>
                                        <li>• Drop-off at airport or hotel in Entebbe/Kampala</li>
                                    </ul>
                                </div>
                            </div>
                            <div className="mt-4 p-4 bg-yellow-50 rounded-lg">
                                ...
                                <p className="text-gray-600 text-sm">Schedule flights for evening (after 6pm) from Entebbe.
                                    For early morning flights, we recommend booking an extra night in Entebbe.</p>
                            </div>
                        </div>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer">
                    <img src="assets/3day-gorilla/gorilla1.png" alt="Mountain Gorilla Encounter" className="w-full h-48 object-cover hover:scale-105 transition-transform" />
                </div>
                <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer">
                    <img src="assets/3day-gorilla/gorilla2.png" alt="Bwindi Impenetrable Forest" className="w-full h-48 object-cover hover:scale-105 transition-transform" />
                </div>
                <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer">
                    <img src="assets/3day-gorilla/gorilla3.png" alt="Batwa Cultural Experience" className="w-full h-48 object-cover hover:scale-105 transition-transform" />
                </div>
                <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer">
                    <img src="assets/3day-gorilla/gorilla4.png" alt="Gorilla Trekking Group" className="w-full h-48 object-cover hover:scale-105 transition-transform" />
                </div>
                {/*  <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer"
                    onClick={undefined}>
                    <img src="assets/3day-gorilla/gorilla1.png" alt="Rushaga Gorilla Lodge"
                        className="w-full h-48 object-cover hover:scale-105 transition-transform">
                </div>
                <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer"
                    onClick={undefined}>
                    <img src="assets/3day-gorilla/gorilla2.png" alt="Forest Trekking"
                        className="w-full h-48 object-cover hover:scale-105 transition-transform">
                </div>
                <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer"
                    onClick={undefined}>
                    <img src="assets/3day-gorilla/gorilla3.png" alt="Gorilla Family"
                        className="w-full h-48 object-cover hover:scale-105 transition-transform">
                </div>
                <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer"
                    onClick={undefined}>
                    <img src="assets/3day-gorilla/gorilla4.png" alt="Batwa Traditional Dance"
                        className="w-full h-48 object-cover hover:scale-105 transition-transform">
                </div>  */}
            </div>
        </div>
        ...
        <section className="py-16 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600">Perfect for last-minute bookings and budget-conscious explorers</p>
                </div>
                    ...
                    <div className="max-w-2xl mx-auto">
                        ...
                        <div className="bg-gray-50 rounded-2xl overflow-hidden shadow-lg">
                            <div className="h-64 overflow-hidden">
                                <img src="assets/3day-gorilla/rushaga-lodge.png" alt="Rushaga Gorilla Lodge" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
                            </div>
                            <div className="p-6">
                                <div className="flex justify-between items-start mb-4">
                                    <div>
                                        <h4 className="text-xl font-bold text-gray-900">Rushaga Gorilla Lodge</h4>
                                        <p className="text-gray-600">Bwindi Impenetrable Forest • 2 Nights</p>
                                    </div>
                                    <span className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm font-medium">Mid-range</span>
                                </div>
                                <p className="text-gray-600 mb-4">Comfortable lodge located near the park headquarters,
                                    offering modern amenities with stunning forest views. Perfect base for gorilla
                                    trekking adventures.</p>
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="flex items-center text-gray-600">
                                        ...
                                        <span className="text-sm">Hot showers</span>
                                    </div>
                                    <div className="flex items-center text-gray-600">
                ...
                <div className="mb-16">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white border border-gray-200 rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <p className="text-gray-600 text-sm">Start any day, perfect last-minute</p>
                        </div>
                        <div className="bg-white border border-gray-200 rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="bg-green-50 rounded-2xl p-6 shadow-sm">
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start">
                                ...
                                <span className="text-gray-700">Airport/hotel transfers in Entebbe/Kampala</span>
                            </li>
                            <li className="flex items-start">
                                <i className="ri-checkbox-circle-fill text-green-500 mt-1 mr-3"></i>
                                <span className="text-gray-700">Private transportation in luxury 4x4 vehicle</span>
                            </li>
                            <li className="flex items-start">
                                <i className="ri-checkbox-circle-fill text-green-500 mt-1 mr-3"></i>
                                <span className="text-gray-700">English-speaking driver/guide throughout</span>
                            </li>
                            <li className="flex items-start">
                                <i className="ri-checkbox-circle-fill text-green-500 mt-1 mr-3"></i>
                            ...
                            <li className="flex items-start">
                                <i className="ri-checkbox-circle-fill text-green-500 mt-1 mr-3"></i>
                                <span className="text-gray-700">Two nights at Rushaga Gorilla Lodge</span>
                            </li>
                            <li className="flex items-start">
                                <i className="ri-checkbox-circle-fill text-green-500 mt-1 mr-3"></i>
                            ...
                            <li className="flex items-start">
                                <i className="ri-checkbox-circle-fill text-green-500 mt-1 mr-3"></i>
                                <span className="text-gray-700">Batwa community visit experience</span>
                            </li>
                            <li className="flex items-start">
                                <i className="ri-checkbox-circle-fill text-green-500 mt-1 mr-3"></i>
                                <span className="text-gray-700">Park entrance fees</span>
                            </li>
                            <li className="flex items-start">
                                <i className="ri-checkbox-circle-fill text-green-500 mt-1 mr-3"></i>
                        ...
                        <div className="mt-6 p-4 bg-white rounded-lg">
                            <p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Gorilla permits
                                are limited and must be booked well in advance. Minimum age: 15 years for gorilla
                                trekking.</p>
                        </div>
                    </div>
        ...
        <section className="py-16 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h2 className="text-4xl font-bold text-gray-900 mb-4">Gorilla Trekking Preparation</h2>
                    <p className="text-xl text-gray-600">Essential information for your 3-day express gorilla adventure</p>
                </div>
                <div className="space-y-4">
                    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                        <button className="w-full px-6 py-4 text-left flex justify-between items-center hover:bg-gray-50 preparation-toggle" data-target="documentation">
                            <h3 className="text-lg font-semibold text-gray-900">Required Documentation & Permits</h3>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <ul className="text-gray-600 space-y-1">
                                        ...
                                        <li>• Gorilla permit confirmation (we provide)</li>
                                    </ul>
                                </div>
                                <div>
                                    <h4 className="font-semibold text-gray-800 mb-2">Permit Information</h4>
                                    <ul className="text-gray-600 space-y-1">
                                        <li>• Gorilla permit: USD $700 per person</li>
                                        <li>• Permits included in tour price</li>
                                        <li>• Must be booked months in advance</li>
                    ...
                    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                        <button className="w-full px-6 py-4 text-left flex justify-between items-center hover:bg-gray-50 preparation-toggle" data-target="packing">
                            <h3 className="text-lg font-semibold text-gray-900">Packing for 3-Day Gorilla Trek</h3>
                            <div className="w-5 h-5 flex items-center justify-center">
                                <i className="ri-arrow-down-s-line text-gray-400 transition-transform duration-200"></i>
                            </div>
                        </button>
                        <div className="px-6 pb-6 hidden preparation-content" id="packing">
                            <div className="grid md:grid-cols-3 gap-6">
                                <div>
                                    <h4 className="font-semibold text-gray-800 mb-2">Trekking Essentials</h4>
                                    <ul className="text-gray-600 space-y-1">
                                        <li>• Waterproof hiking boots (broken in)</li>
                                        <li>• Garden gloves for vegetation</li>
                                        <li>• Lightweight rain jacket/poncho</li>
                                        <li>• Small daypack (waterproof)</li>
                                ...
                                <div>
                                    ...
                                    <ul className="text-gray-600 space-y-1">
                                        ...
                                        <li>• Warm layer (fleece/jacket)</li>
                                        <li>• Hat with brim</li>
                    ...
                    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                        <button className="w-full px-6 py-4 text-left flex justify-between items-center hover:bg-gray-50 preparation-toggle" data-target="fitness">
                            <h3 className="text-lg font-semibold text-gray-900">Fitness & Gorilla Trekking Protocol</h3>
                            <div className="w-5 h-5 flex items-center justify-center">
                                <i className="ri-arrow-down-s-line text-gray-400 transition-transform duration-200"></i>
                            </div>
                        </button>
                        <div className="px-6 pb-6 hidden preparation-content" id="fitness">
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    <h4 className="font-semibold text-gray-800 mb-2">Physical Requirements</h4>
                                    <ul className="text-gray-600 space-y-1">
                                        <li>• Moderate fitness level required</li>
                                        <li>• Trekking duration: 2-6 hours</li>
                                        <li>• Altitude: 1,190-2,607 meters</li>
                                        <li>• Uneven, muddy terrain</li>
                                ...
                                <div>
                                    ...
                                    <ul className="text-gray-600 space-y-1">
                                        <li>• Maximum 8 visitors per gorilla group</li>
                                        <li>• Stay 7 meters from gorillas</li>
                                        <li>• No flash photography</li>
                                        <li>• Keep voices low at all times</li>
                                        <li>• If sick (cold/flu), do not trek</li>
        ...
        <section className="py-16 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600">All-inclusive 3-day express gorilla adventure</p>
                </div>
                <div className="bg-gray-50 rounded-2xl p-8">
                    <div className="grid lg:grid-cols-2 gap-8">
                        <div>
                            <h3 className="text-2xl font-bold text-gray-900 mb-6">3-Day Gorilla Trekking & Batwa Experience
                            </h3>
                            <div className="space-y-4">
                                ...
                                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                                    <span className="text-gray-700">Batwa cultural experience</span>
                                    
                                </div>
                                <div className="flex justify-between items-center py-3 border-b border-gray-200">
                                    <span className="text-gray-700">Transportation & guiding</span>
                                ...
                                <div className="flex justify-between items-center py-3 font-bold text-lg bg-green-50 px-4 rounded-lg">
                                    ...
                                    <span className="text-secondary text-2xl">$2,540 USD*</span>
                                </div>
                                <p className="text-xs text-gray-500 mt-2 italic">*Prices are subject to change based on
                                    season, availability, and exchange rates.</p>
                            </div>
                            <div className="mt-8 p-4 bg-blue-50 rounded-lg">
                                <h4 className="font-semibold text-blue-800 mb-2">Last-Minute Booking Benefits</h4>
                                <ul className="text-blue-700 text-sm space-y-1">
                                    <li>• Quick confirmation (24-48 hours if permits available)</li>
                                    <li>• Flexible payment options</li>
                                    <li>• Complimentary airport transfer coordination</li>
                                    <li>• Free trip planning consultation</li>
                                </ul>
                            </div>
                        </div>
                        <div>
                            <div className="bg-white rounded-xl p-6 shadow-lg mb-6">
                                ...
                                <ul className="text-gray-600 space-y-2">
                                    <li>• All accommodation (2 nights mid-range lodge)</li>
                                    <li>• All meals as specified in itinerary</li>
                                    <li>• Professional English-speaking guide</li>
                                    <li>• Private 4x4 transportation throughout</li>
                                    <li>• Gorilla trekking permit (USD $700 value)</li>
                                    <li>• Batwa Cultural Experience visit</li>
                                    <li>• Park entrance fees for Bwindi</li>
                                    <li>• Airport/hotel transfers in Entebbe/Kampala</li>
                            ...
                            <div className="bg-white rounded-xl p-6 shadow-lg">
                                ...
                                <ul className="text-gray-600 space-y-2">
                                    ...
                                    <li>• Single supplement: $250</li>
                                    <li>• Gorilla permits non-refundable</li>
                                    <li>• Minimum age: 15 years</li>
                                    <li>• Maximum group: 8 people (park rule)</li>
                                    <li>• 50% deposit required to secure permits</li>
                                    <li>• Balance due 30 days before travel</li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div id="bookingModal" className="fixed inset-0 z-50 hidden w-full h-full bg-black bg-opacity-80 overflow-y-auto">
            <div className="relative w-full min-h-screen flex items-center justify-center px-4 py-12">
                <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl relative fade-in">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">Book Your 3-Day Gorilla Trekking
                        Adventure</h2>
                    <form id="customBookingForm" className="space-y-6">
                        <input type="hidden" name="safari" defaultValue="3-Day Gorilla Trekking & Batwa Experience" />
                        <div>
